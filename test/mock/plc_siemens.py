...
class Siemens(object):
    ...
    def __init__(self):
        ...
        self.inHoursCluster = Siemens.add_node_string(dpu_to_plc, idx, "inHoursCluster ", ua.Variant(21*[0], ua.VariantType.UInt16))
        self.inHoursCluster.set_array_dimensions([21])
        self.inHoursCluster.set_value_rank(1)
        self.inInkLevels = Siemens.add_node_string(dpu_to_plc, idx, "inInkLevels", ua.Variant(7*[1], ua.VariantType.UInt16))
        self.inInkLevels.set_array_dimensions([6])
        self.inInkLevels.set_value_rank(1)
        ...
        self.boReqPause = Siemens.add_node_string(dpu_to_plc, idx, "boReqPause", False, ua.VariantType.Boolean)
        ...
        self.inWebWidth = Siemens.add_node_string(dpu_to_plc, idx, "inWebWidth", 0, ua.VariantType.Int16)
        ...
        self.boChangeJob = Siemens.add_node_string(plc_to_dpu, idx,"boChangeJob",False,ua.VariantType.Boolean)
        ...
        self.boReqStopAck = Siemens.add_node_string(plc_to_dpu, idx,"boReqStopExt",False,ua.VariantType.Boolean)
        self.boMachineIsStopped = Siemens.add_node_string(plc_to_dpu, idx,"boMachineIsStopped",False,ua.VariantType.Boolean)
        self.boReqPauseAck = Siemens.add_node_string(plc_to_dpu, idx,"boReqPauseExt",False,ua.VariantType.Boolean)
