...
BEGIN_MESSAGE_MAP(CSambaTestApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CSambaTestApp construction

CSambaTestApp::CSambaTestApp()
{
...
// The one and only CSambaTestApp object

CSambaTestApp theApp;

long WINAPI exception(LPEXCEPTION_POINTERS ExceptionInfo)
{
	HANDLE hFile;
	wchar_t FILENAME_MINIDUMP[] = L"Samba-Test.dmp";

//	TrPrintf(TRUE, L"Exception");
//	TrClose();
...
// CSambaTestApp initialization

BOOL CSambaTestApp::InitInstance()
{
