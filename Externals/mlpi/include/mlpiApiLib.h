...
//! <TR><TD id="st_e"> @ref mlpiApiConnect                          </TD><TD> 1.0.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_ALWAYS"                      </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiDisconnect                       </TD><TD> 1.0.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_ALWAYS"                      </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiSetDefaultTimeout                </TD><TD> 1.0.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_ALWAYS"                      </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiGetDefaultTimeout                </TD><TD> 1.0.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_ALWAYS"                      </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiIsConnected                      </TD><TD> 1.0.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_ALWAYS"                      </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiTestConnection                   </TD><TD> 1.0.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_CONNECTION_INFO"             </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD> x    </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiDelay                            </TD><TD> 1.0.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_CONNECTION_INFO"             </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD> x    </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiGetClientCoreVersion             </TD><TD> 1.0.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_ALWAYS"                      </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiGetServerCoreVersion             </TD><TD> 1.0.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_MLPI_INFO"                   </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiSetNameOfConnection              </TD><TD> 1.1.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_CONNECTION_OWN_DESCRIPTION"  </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD> x    </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiSetLabelOfConnection             </TD><TD> 1.1.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_CONNECTION_OWN_DESCRIPTION"  </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD> x    </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiGetOwnConnectionDescription      </TD><TD> 1.1.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_CONNECTION_OWN_DESCRIPTION"  </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD> x    </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiGetAllConnectionDescription      </TD><TD> 1.1.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_CONNECTION_ALL_DESCRIPTION"  </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD> x    </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiCloseConnectionByUid             </TD><TD> 1.1.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_CONNECTION_CLOSE"            </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD>      </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiCloseConnectionsByUser           </TD><TD> 1.1.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_CONNECTION_CLOSE"            </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD>      </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiCloseConnectionsByUri            </TD><TD> 1.1.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_CONNECTION_CLOSE"            </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD>      </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiUserAccountControlReload         </TD><TD> 1.1.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_USER_ACCOUNT_CONTROL_RELOAD" </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD>      </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiUserAccountControlLoadAccounts   </TD><TD> 1.4.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_USER_ACCOUNT_CONTROL_LOAD"   </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD>      </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiUserAccountControlUnloadAccounts </TD><TD> 1.4.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_USER_ACCOUNT_CONTROL_LOAD"   </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD>      </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiGetOwnPermissions                </TD><TD> 1.4.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_ALWAYS"                      </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiGetAccounts                      </TD><TD> 1.4.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_USER_ACCOUNT_CONTROL_ACCESS" </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD>      </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiGetAccountPermissions            </TD><TD> 1.4.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_USER_ACCOUNT_CONTROL_ACCESS" </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD>      </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiApiNotifyAlive                      </TD><TD> 1.4.0.0        </TD><TD> "MLPI_APILIB_PERMISSION_ALWAYS"                      </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD></TR>
//! </TABLE>
//!
//! <TABLE>
...
//! via a network, for example by TCP/IP. In this case you have to give the IP or host name to the target. Alternative
//! this address argument can set as an option on each place within the connect ident string.
//!
...
//! <TR><TD> @c @b keepalive_mode_server=value        </TD><TD> If set to 1 (default, ifn't set), then the MLPI server will send a MLPI keepalive
...
//! @code
//! MLPIHANDLE connection = 0;
//! MLPIRESULT result = mlpiApiConnect(L"192.168.0.42:5300 -timeout_connect=2000 -timeout_send=5000 -timeout_receive=5000 -user=guest -password=guest -auto_reconnect=true", &connection);
//! if (MLPI_FAILED(result)){
//!   printf("\nfailed to connect to MLPI with 0x%08x", (unsigned)result);
//!   return;
//! }else{
...
//! mlpiApiConnect(L"192.168.0.42", &handle2);
//!
//! WCHAR szText1[128];
//! WCHAR szText2[128];
...
//! <TR><TD id="st_t"> The given connection ident string doesn't contain an addressee.                                                                          </TD><TD id="st_e"> MLPI_E_INVALIDARG         </TD></TR>
