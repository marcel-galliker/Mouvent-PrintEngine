...
//! <TR><TD id="st_e"> @ref mlpiWatchdogSetup     </TD><TD> 1.0.0.0        </TD><TD> "MLPI_WATCHDOGLIB_PERMISSION_USE"  </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD>      </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiWatchdogStart     </TD><TD> 1.0.0.0        </TD><TD> "MLPI_WATCHDOGLIB_PERMISSION_USE"  </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD>      </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiWatchdogStop      </TD><TD> 1.0.0.0        </TD><TD> "MLPI_WATCHDOGLIB_PERMISSION_USE"  </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD>      </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiWatchdogReset     </TD><TD> 1.0.0.0        </TD><TD> "MLPI_WATCHDOGLIB_PERMISSION_USE"  </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD>      </TD></TR>
//! <TR><TD id="st_e"> @ref mlpiWatchdogGetState  </TD><TD> 1.0.0.0        </TD><TD> "MLPI_WATCHDOGLIB_PERMISSION_USE"  </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD> x    </TD><TD>      </TD><TD>      </TD></TR>
//! </TABLE>
//!
//! <TABLE>
