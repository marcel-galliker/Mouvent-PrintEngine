...
/* Set the callback functions for planeio
* The alloc callback function should return an array of buffers
* provided by the caling process.
* The done call back will give to calling process bitmap raters of all planes
* If a callback address is NULL, normal device output will be used.
*/
GSDLLEXPORT int GSDLLAPI
gsapi_set_planeio(void *instance,
	int (GSDLLCALLPTR planealloc_fn)(void *caller_handle, int planes, int width, int heigth, char ***buf),
	int (GSDLLCALLPTR planedone_fn)(void *caller_handle));
...
typedef int (GSDLLAPIPTR PFN_gsapi_set_stdio)(void *instance,
    ...
    int (GSDLLCALLPTR stdout_fn)(void *caller_handle, const char *str, int len),
    int (GSDLLCALLPTR stderr_fn)(void *caller_handle, const char *str, int len));
typedef int (GSDLLAPIPTR PFN_gsapi_set_planeio)(void *instance,
	int (GSDLLCALLPTR planealloc_fn)(void *caller_handle, int planes, int width, int heigth, char ***buf),
	int (GSDLLCALLPTR planedone_fn)(void *caller_handle));
