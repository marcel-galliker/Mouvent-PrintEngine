...
#ifndef _TEC_WIN_ERROR_H_
#define _TEC_WIN_ERROR_H_

// Std Facilities
// ---------------------------------
#define FacGeneric						0x00000000	/* Generic (or unknown facility)		*/
#define	FacCOM							  0x00000001	/* COM / DCOM								        */	
#define FacListener           0x00000002  /* Listener Threads for PrintServer */
...
#define	FacBarCode						0x00000020	/* Bar code Generator						    */
#define FacMiniC						  0x00000022	/* MiniC Interpreter						    */
#define FacPlaylist						0x00000023	/* Play list (print server)			    */
#define FacPlaylistFile				0x00000024	/* Play list file (print server)		*/
#define FacDebug						  0x00000025	/* Debug-Traces (testing only)			*/
#define FacWebServer          0x00000026	/* Web Server                       */
#define FacController         0x00000027	/* Repository Controller            */


#ifdef _WIN32
# include <winerror.h>
# if defined(TEC_WINCE) || (_MSC_VER <= 1410)
  ...
  #if (defined(_WIN32) && !defined(_MAC)) || defined(_TEC_UNIX)
  //
  // MessageId: E_NOTIMPL
  //
  // MessageText:
