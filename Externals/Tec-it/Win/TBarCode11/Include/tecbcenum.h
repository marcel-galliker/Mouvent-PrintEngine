...
/* eBC_2D_Mailmark,         1:1                         (1B:1S)                             ----                                                */
/* eBC_UpuS10,              1:2:3:4:1:2:3:4             (1B:2B:3B:4B:1S:2S:3S:4S)           eCDUPU                                              */
/* eBC_4state_Mailmark,     1:1                         (1B:1S)                             eCDNone                                             */
/* eBC_HIBCLicAztec,        1:1                         (1B:1S)                             eCDMod43                                            */
/* eBC_HIBCPasAztec,        1:1                         (1B:1S)                             eCDMod43                                            */
...
/// @endcond 
{
  ...
  TECIT_HS("HIBC PAS 128")                    eBC_HIBCPas128 = 100,       ///< <b> HIBC PAS 128 </b>\n Enumeration Value: 100
                                                                          ...
                                                                          ///< \n The content of HIBC PAS 128 / HIBC PAS 39 is specified by the HIBC Provider Applications Standard. It may consist of a Single, a Multiple, or a Split Data Field Format. 
                                                                          ///< The multiple format can contain 2 or more data fields within one barcode symbol. The split format, which allows to split the data into 2 single symbols, is only available in the legacy version of HIBC PAS 1.2.
                                                                          ...
                                                                          ///< \n
                                                                          ///< \n The multiple format is defined as:
                                                                          ...
                                                                          ///< - C        ... Check Digit (mod 43)
                                                                          ///< HINT: A multiple format can consist of more than 2 parts. In this case "/", G2*, and D2 are repeated.
                                                                          ///< \n
                                                                          ///< \n The First Part of the Split Data Format (only used in legacy PAS version V1.2!) looks like: 
                                                                          ///< +/1F*G*DDDDC
  ...
  TECIT_HS("Swedish Postal Shipment Item ID") eBC_SwedishPostal = 118,    ///< <b> Swedish Postal Shipment Item ID Barcode </b> \n Enumeration Value: 118
                                                                          ...
                                                                          ///< \n\n
  TECIT_HS("Royal Mail Mailmark 2D")          eBC_2D_Mailmark = 119,      ///< <b> Royal Mail Mailmark 2D </b> \n Enumeration Value: 119
  ...
  TECIT_HS("Royal Mail CMDM Mailmark")        eBC_CMDM_Mailmark = 119,    ///< <b> Royal Mail Complex Mail Data Mark (CMDM) Mailmark </b> \n Enumeration Value: 119
                                                                          ///< \n Same as #eBC_Mailmark_2D. Old name of Royal Mail Mailmark 2D
                                                                          ///< \n\n
  TECIT_HS("UPU S10")                         eBC_UpuS10 = 120,           ///< <b> UPU S10 - Identification of postal items </b> \n Enumeration Value: 120
                                                                          ...
                                                                          ///< \n\n
  TECIT_HS("Royal Mail Mailmark 4-state")     eBC_4state_Mailmark = 121,  ///< <b> Royal Mail Mailmark 4-state </b> \n Enumeration Value: 121
                                                                          ...
                                                                          ///< - The code consists of either 22 (variant C) or 26 (variant L) characters, which are composed of letters,
                                                                          ///<   digits, and spaces.
                                                                          ///< - Codeable characters: see above
                                                                          ///< - Default and recommended check-digit method: None (check digit and error correction is included in the code)
                                                                          ///< - Recommended check digit methods: None
  TECIT_HS("HIBC LIC Aztec Code")             eBC_HIBCLicAztec = 122,     ///< <b> HIBC LIC Aztec Code </b>\n Enumeration Value: 122
                                                                          ///< \n HIBC LIC Aztec Code uses Aztec Code as base symbology; It has a special check digit (modulo 43).
                                                                          ///< \n For a short format description see also #eBC_HIBCLic128 (Single and Combined Format, splitting is not allowed). 
                                                                          ///< \n\n
  TECIT_HS("HIBC PAS Aztec Code")             eBC_HIBCPasAztec = 123,     ///< <b> HIBC PAS Aztec Code </b>\n Enumeration Value: 123
...
/// @endcond 
{
    ...
    TECIT_HS("Mod-11 (W=9)")                        eCDMod11W9      ,           ///< =35: Mod 11 (using maximum weight 9)
    TECIT_HS("Mod-37,2")                            eCDMod37WP2     ,           ///< =36: Mod 37,2 (ISO 7064, using maximum weight of 2^9)
} e_CDMethod;
...
/// @endcond 
{
    ...
    TECIT_HS("8   x 48")                            eDMSz_8x48,     ///< =31: Fixed rectangular symbol-size   8 x 48 (DMRE)
    TECIT_HS("8   x 64")                            eDMSz_8x64,     ///< =32: Fixed rectangular symbol-size   8 x 64 (DMRE)
    TECIT_HS("12  x 64")                            eDMSz_12x64,    ///< =33: Fixed rectangular symbol-size  12 x 64 (DMRE)
    TECIT_HS("16  x 64")                            eDMSz_16x64,    ///< =34: Fixed rectangular symbol-size  16 x 64 (DMRE)
    TECIT_HS("24  x 32")                            eDMSz_24x32,    ///< =35: Fixed rectangular symbol-size  24 x 32 (DMRE)
    TECIT_HS("24  x 36")                            eDMSz_24x36,    ///< =36: Fixed rectangular symbol-size  24 x 36 (DMRE)
    TECIT_HS("24  x 48")                            eDMSz_24x48,    ///< =37: Fixed rectangular symbol-size  24 x 48 (DMRE)
    TECIT_HS("24  x 64")                            eDMSz_24x64,    ///< =38: Fixed rectangular symbol-size  24 x 64 (DMRE)
    TECIT_HS("26  x 32")                            eDMSz_26x32,    ///< =39: Fixed rectangular symbol-size  26 x 32 (DMRE)
    TECIT_HS("26  x 40")                            eDMSz_26x40,    ///< =40: Fixed rectangular symbol-size  26 x 40 (DMRE)
    TECIT_HS("26  x 48")                            eDMSz_26x48,    ///< =41: Fixed rectangular symbol-size  26 x 48 (DMRE)
    TECIT_HS("26  x 64")                            eDMSz_26x64,    ///< =42: Fixed rectangular symbol-size  26 x 64 (DMRE)
    // ISO21471
    TECIT_HS("8   x 80")                            eDMSz_8x80,     ///< =43: Fixed rectangular symbol-size   8 x 80 (ISO21471)
    TECIT_HS("8   x 96")                            eDMSz_8x96,     ///< =44: Fixed rectangular symbol-size   8 x 96 (ISO21471)
    TECIT_HS("8   x 120")                           eDMSz_8x120,    ///< =45: Fixed rectangular symbol-size   8 x 120 (ISO21471)
    TECIT_HS("8   x 144")                           eDMSz_8x144,    ///< =46: Fixed rectangular symbol-size   8 x 144 (ISO21471)
    TECIT_HS("12  x 88")                            eDMSz_12x88,    ///< =47: Fixed rectangular symbol-size  12 x 88 (ISO21471)
    TECIT_HS("20  x 36")                            eDMSz_20x36,    ///< =48: Fixed rectangular symbol-size  20 x 36 (ISO21471)
    TECIT_HS("20  x 44")                            eDMSz_20x44,    ///< =49: Fixed rectangular symbol-size  20 x 44 (ISO21471)
    TECIT_HS("20  x 64")                            eDMSz_20x64,    ///< =50: Fixed rectangular symbol-size  20 x 64 (ISO21471)
    TECIT_HS("22  x 40")                            eDMSz_22x40,    ///< =51: Fixed rectangular symbol-size  22 x 40 (ISO21471)
    TECIT_HS("22  x 48")                            eDMSz_22x48,    ///< =52: Fixed rectangular symbol-size  22 x 48 (ISO21471)
} e_DMSizes;
#endif // TEC_DISABLE_DATAMATRIX
...
/// @endcond 
{
    ...
    TECIT_HS("Code 128 Emulation")                    eMPDFPr_C128Std,      ///< =2: Code128 Emulation. Transmit ]C0 or ]L5
    TECIT_HS("Code 128 FNC1 2nd Pos")                 eMPDFPr_C128FNC2,     ///< =3: Code128 Emulation with FNC1 on second position. Transmit ]C2 or ]L4
    ...
    TECIT_HS("05 Macro")                              eMPDFPr_05Macro,      ///< =5: 05 Macro. The preamble [ ( > RS 0 5 GS precedes the encoded data. The postamble RS EOT follows the encoded data.
    TECIT_HS("06 Macro")                              eMPDFPr_06Macro,      ///< =6: 06 Macro. The preamble [ ( > RS 0 6 GS precedes the encoded data. The postamble RS EOT follows the encoded data.
...
/// @endcond 
{
  ...
  TECIT_HS("Default Code Page") eCodePage_Custom = 0,
  ...
  TECIT_HS("Default Code Page") eCodePage_Default = 1,

  /// =2: ANSI Code Page 
  /// (use the ANSI code page from the setting "Language for non-Unicode programs").\n
  TECIT_HS("ANSI") eCodePage_ANSI = 2,

  /// =3: Windows-1252 (1252).
  TECIT_HS("Windows-1252 (1252)") eCodePage_Windows1252 = 3,

  /// =4: ISO 8859-1 Latin I (28591).
  TECIT_HS("ISO 8859-1 Latin I (28591)") eCodePage_Latin_I = 4,

  /// =5: ASCII Extended (437).
  TECIT_HS("ASCII Extended (437)") eCodePage_ASCIIExt_437 = 5,

  /// =6: Unicode UTF-8, ISO/IEC 10646 (65001).
  TECIT_HS("Unicode UTF-8") eCodePage_UTF8 = 6,

  /// =7: Korean (949).
  TECIT_HS("Korean (949)") eCodePage_Korean = 7,
  
  /// =8: Japanese / Shift-JIS (932).
  TECIT_HS("Japanese / Shift-JIS (932)") eCodePage_Japanese_Shift_JIS = 8,
  
  /// =9: Simplified Chinese (936).
  TECIT_HS("Simplified Chinese (936)") eCodePage_Simplified_Chinese = 9,
  
  /// =10: Traditional Chinese (950).
  TECIT_HS("Traditional Chinese (950)") eCodePage_Trad_Chinese_Big5 = 10,
  
  /// =11: ANSI - Cyrillic (1251).
  TECIT_HS("ANSI - Cyrillic (1251)") eCodePage_ANSI_Cyrillic = 11,
  
  /// =12: Russian KOI8-R (20866).
  TECIT_HS("Russian KOI8-R (20866)") eCodePage_KOI8_R = 12,

  /// =13: Chinese GB18030 (54936).
  TECIT_HS("Chinese GB18030 (54936)") eCodePage_GB18030 = 13,

  /// =14: MAC Roman, Western European (10000).
  TECIT_HS("MAC Roman (10000)") eCodePage_MAC_Roman = 14,

  /// =4:  ISO 8859-1 Latin 1, Western European (28591).
  TECIT_HS("ISO 8859-1 (28591)") eCodePage_ISO_8859_1 = 4,

  /// =15:  ISO 8859-2 Central European (28592).
  TECIT_HS("ISO 8859-2 (28592)") eCodePage_ISO_8859_2 = 15,

  /// =16:  ISO 8859-3 Latin 3, South European(28593).
  TECIT_HS("ISO 8859-3 (28593)") eCodePage_ISO_8859_3 = 16,

  /// =17:  ISO 8859-4 Baltic (28594).
  TECIT_HS("ISO 8859-4 (28594)") eCodePage_ISO_8859_4 = 17,

  /// =18:  ISO 8859-5 Cyrillic (28595).
  TECIT_HS("ISO 8859-5 (28595)") eCodePage_ISO_8859_5 = 18,

  /// =19:  ISO 8859-6 Arabic (28596).
  TECIT_HS("ISO 8859-6 (28596)") eCodePage_ISO_8859_6 = 19,
  
  /// =20:  ISO 8859-7 Greek (28597).
  TECIT_HS("ISO 8859-7 (28597)") eCodePage_ISO_8859_7 = 20,

  /// =21:  ISO 8859-8 Hebrew (28598).
  TECIT_HS("ISO 8859-8 (28598)") eCodePage_ISO_8859_8 = 21,

  /// =22:  ISO 8859-9 Turkish (28599).
  TECIT_HS("ISO 8859-9 (28599)") eCodePage_ISO_8859_9 = 22,

  /// =23:  ISO 8859-10 Latin-6 (28600). Codepage may not be available on all systems.
  TECIT_HS("ISO 8859-10 (28600)") eCodePage_ISO_8859_10 = 23,

  /// =24:  ISO 8859-11 Latin/Thai (28601). Codepage may not be available on all systems.
  TECIT_HS("ISO 8859-11 (28601)") eCodePage_ISO_8859_11 = 24,

  /// =25:  ISO 8859-13 Latin-7, Estonian / Baltic Rim (28603).
  TECIT_HS("ISO 8859-13 (28603)") eCodePage_ISO_8859_13 = 25,

  /// =26:  ISO 8859-14 Latin-8, Celtic (28604). Codepage may not be available on all systems.
  TECIT_HS("ISO 8859-14 (28604)") eCodePage_ISO_8859_14 = 26,

  /// =27:  ISO 8859-15 Latin-9, Western European (28605).
  TECIT_HS("ISO 8859-15 (28605)") eCodePage_ISO_8859_15 = 27,

  /// =28:  ISO 8859-16 Latin-10, South-Eastern European (28606). Codepage may not be available on all systems.
  TECIT_HS("ISO 8859-16 (28606)") eCodePage_ISO_8859_16 = 28,
  ...
  TECIT_HS("Unicode UTF-16LE (1200)") eCodePage_UTF16LE = 29,
  ...
  TECIT_HS("Unicode UTF-16BE (1201)") eCodePage_UTF16BE = 30,
