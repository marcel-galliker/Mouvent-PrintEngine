...
void mem_test()
{
	...
	int i;
	term_printf(  "Time:        "); for (i=0; i<MAX_LIST_LEN; i++) term_printf("%10d", _MemSizeList[i].time);
	term_printf("\nMemTotal:    "); for (i=0; i<MAX_LIST_LEN; i++) term_printf("%10d", _MemSizeList[i].memTotal);
	term_printf("\nMemFree:     "); for (i=0; i<MAX_LIST_LEN; i++) term_printf("%10d", _MemSizeList[i].memFree);
	term_printf("\nMemAvailable:"); for (i=0; i<MAX_LIST_LEN; i++) term_printf("%10d", _MemSizeList[i].memAvailable);
	term_printf("\n");
}
