 ...
 ** Bit#0 : (reserved)  
 ******************************************************************************/ 
//#define SCM_CTL_Val           0x00000052ul    // <<< Define SCM_CTL here //default main osc with pll
//#define SCM_CTL_Val           0x00000050ul    // <<< Define SCM_CTL here	// internal osc with pll
//#define SCM_CTL_Val           0x00000022ul    // <<< Define SCM_CTL here //main clk, no pll 4MHz

#define SCM_CTL_Val           0x00000000ul    // <<< Define SCM_CTL here //internal clk 4MHz
 ...
 ** - 7 = (reserved)
 ******************************************************************************/    
//#define BSC_PSR_Val           0x00000005ul    // <<< Define BSC_PSR here
 ...
 ** - 3 = PCLK0 = HCLK / 8
 ******************************************************************************/    
#define APBC0_PSR_Val         0x00000001UL     // <<< Define APBC0_PSR here 2 MHz
 ...
 ** - 3 = PCLK1 = HCLK / 8
 ******************************************************************************/     
#define APBC1_PSR_Val         0x00000083ul    // <<< Define APBC1_PSR here 0.25 MHz
 ...
 ** - 3 = PCLK2 = HCLK / 8
 ******************************************************************************/    
#define APBC2_PSR_Val         0x00000081ul    // <<< Define APBC2_PSR here 2 MHz
 ...
 ** - 7 = ~16.40 ms
 ******************************************************************************/    
//#define PSW_TMR_Val           0x00000000ul    // <<< Define PSW_TMR here //main oscillation
#define PSW_TMR_Val           0x00000010ul    // <<< Define PSW_TMR here //high-speed cr clock
/**
 ******************************************************************************
 ...
 ******************************************************************************/    
//#define PLL_CTL1_Val          0x00000001ul    // <<< Define PLL_CTL1 here 160mhz
#define PLL_CTL1_Val          0x00000003ul    // <<< Define PLL_CTL1 here 80mhz
 ...
 ******************************************************************************/    
//#define PLL_CTL2_Val          0x00000027ul    // <<< Define PLL_CTL2 here 1/40 160mhz
#define PLL_CTL2_Val          0x00000013ul    // <<< Define PLL_CTL2 here 1/20 80mhz  
