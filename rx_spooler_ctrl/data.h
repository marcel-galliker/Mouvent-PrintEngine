...
int  data_get_size	(const char *path, UINT32 page, UINT32 *pspacePx, UINT32 *pwidth, UINT32 *plength, UINT8 *bitsPerPixel, UINT8 *multiCopy);
...
int  data_same		(SPageId *id, int clrerearBlockUsed);
