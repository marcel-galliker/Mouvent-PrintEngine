...
{
    public partial class PrinterImage : UserControl
    {
        //--- constructor ------------------------------------------
        ...
        private void _ErrorTypeChanged(ELogType errorType)
        {
            switch(errorType)
            {
                ...
                case ELogType.eErrWarn:  this.Background= Brushes.Yellow; break;
                case ELogType.eErrCont:  this.Background= Brushes.Red; break;
                case ELogType.eErrStop:  this.Background= Brushes.Red; break;
                case ELogType.eErrAbort: this.Background= Brushes.Red; break;
            }
        }
