    ...
    public class EN_PrinterTypeList: IEnumerable
    {
        ...
        public EN_PrinterTypeList()
        {
            if (_List==null)
            {
				...
				_List.Add(new RxEnum<EPrinterType>(EPrinterType.printer_LB703_UV,           "Mouvent LB703-UV"   ));
                _List.Add(new RxEnum<EPrinterType>(EPrinterType.printer_LH702,              "Mouvent LH702"     ));
