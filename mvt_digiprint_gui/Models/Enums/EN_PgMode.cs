...
namespace RX_DigiPrint.Models.Enums
{
    ...
    {
        private List<RxEnum<TcpIp.EPrintGoMode>> _List;
        public EN_PgModeList()
        {
            ...
            if (!RxGlobals.PrintSystem.isHybrid)
            {
            ...
            else _List.Add(new RxEnum<TcpIp.EPrintGoMode>(TcpIp.EPrintGoMode.PG_MODE_MARK_VRT, RX_DigiPrint.Resources.Language.Resources.MarkV,  new BitmapImage(new Uri("../../Resources/Bitmaps/PG_Mark_Virtual.ico", UriKind.Relative))));
        }
