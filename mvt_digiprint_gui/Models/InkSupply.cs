...
namespace RX_DigiPrint.Models
{
    public class InkSupply  : RxBindable
    {
        ...
        private byte _AirCusionValve;
        public byte AirCusionValve
        {
		...
		//--- Property Flushed ---------------------------------------
        private bool _FlushAvailable = true;
        public bool FlushAvailable
        {
            get { return _FlushAvailable; } 
           set { SetProperty(ref _FlushAvailable, value); }
        }
        ...
        //  Warn            = msg.warn;
         ...
         //   BleedValve      = (msg.info & 0x00000002)!=0;
         //   AirCusionValve  = (msg.info & 0x00000004)!=0;
            Flushed         = (msg.info & 0x00000008)!=0;
			FlushAvailable  = (msg.info & 0x00000080)!=0;
            ...
            if (Err!=0)    
            {
                Console.WriteLine("InkSupply[{0}].Error=0x{1:X}", No, Err);
                UpdateStateBrush(Rx.BrushError);
            }
