...
# Create a new driver
create_driver i2c_master_driver

# Associate it with some hardware known as "i2c_master"
set_sw_property hw_class_name i2c_master
...
# C/C++ source files
add_sw_property c_source HAL/src/i2c_master.c

# Include files
add_sw_property include_source HAL/inc/i2c_master.h
add_sw_property include_source inc/i2c_master_regs.h
