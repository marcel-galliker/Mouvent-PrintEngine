...
# Memory: onchip_memory_nios_arm
MEM_0 := fluid_board_soc_onchip_memory_nios_arm
$(MEM_0)_NAME := onchip_memory_nios_arm
...
$(MEM_0)_END := 0x00057fff
$(MEM_0)_SPAN := 0x00008000
$(MEM_0)_HIERARCHICAL_PATH := onchip_memory_nios_arm
$(MEM_0)_WIDTH := 16
$(MEM_0)_HEX_DATA_WIDTH := 16
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: onchip_memory_nios_arm
onchip_memory_nios_arm: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: onchip_memory_nios_cpu
MEM_1 := fluid_board_soc_onchip_memory_nios_cpu
$(MEM_1)_NAME := onchip_memory_nios_cpu
...
$(MEM_1)_HIERARCHICAL_PATH := onchip_memory_nios_cpu
$(MEM_1)_WIDTH := 32
$(MEM_1)_HEX_DATA_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: onchip_memory_nios_cpu
onchip_memory_nios_cpu: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
