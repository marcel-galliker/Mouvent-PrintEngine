add wave -noupdate -divider {fluid_board_soc_nios2_qsys_0: top-level ports}
...
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/cpu_resetrequest
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/cpu_resettaken
add wave -noupdate -divider {fluid_board_soc_nios2_qsys_0: base pipeline}
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/clk
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/reset_n
...
add wave -noupdate -divider {fluid_board_soc_nios2_qsys_0: cpu_reset}
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/cpu_resetrequest
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/cpu_resettaken
