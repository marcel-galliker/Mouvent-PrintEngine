...
--synthesis_resources = 
 ...
 ENTITY  fluid_board_soc_mm_interconnect_0_rsp_demux_001 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END fluid_board_soc_mm_interconnect_0_rsp_demux_001;

 ARCHITECTURE RTL OF fluid_board_soc_mm_interconnect_0_rsp_demux_001 IS
	 ...
	 SIGNAL  s_wire_fluid_board_soc_mm_interconnect_0_rsp_demux_001_wideor0_11_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	s_wire_fluid_board_soc_mm_interconnect_0_rsp_demux_001_wideor0_11_dataout <= ((((wire_w_lg_w_sink_channel_range1w2w(0) OR wire_w_lg_w_sink_channel_range3w4w(0)) OR wire_w_lg_w_sink_channel_range6w7w(0)) OR wire_w_lg_w_sink_channel_range9w10w(0)) OR wire_w_lg_w_sink_channel_range12w13w(0));
	sink_ready <= s_wire_fluid_board_soc_mm_interconnect_0_rsp_demux_001_wideor0_11_dataout;
	src0_channel <= ( "0" & "0" & "0" & "0" & "0" & sink_channel(18 DOWNTO 5));
	src0_data <= ( sink_data(130 DOWNTO 0));
	src0_endofpacket <= sink_endofpacket;
	src0_startofpacket <= sink_startofpacket;
	src0_valid <= (sink_valid(0) AND sink_channel(0));
	src1_channel <= ( "0" & "0" & "0" & "0" & "0" & sink_channel(18 DOWNTO 5));
	src1_data <= ( sink_data(130 DOWNTO 0));
	src1_endofpacket <= sink_endofpacket;
	src1_startofpacket <= sink_startofpacket;
	src1_valid <= (sink_valid(0) AND sink_channel(1));
	src2_channel <= ( "0" & "0" & "0" & "0" & "0" & sink_channel(18 DOWNTO 5));
	src2_data <= ( sink_data(130 DOWNTO 0));
	src2_endofpacket <= sink_endofpacket;
	src2_startofpacket <= sink_startofpacket;
	src2_valid <= (sink_valid(0) AND sink_channel(2));
	src3_channel <= ( "0" & "0" & "0" & "0" & "0" & sink_channel(18 DOWNTO 5));
	src3_data <= ( sink_data(130 DOWNTO 0));
	src3_endofpacket <= sink_endofpacket;
	src3_startofpacket <= sink_startofpacket;
	src3_valid <= (sink_valid(0) AND sink_channel(3));
	src4_channel <= ( "0" & "0" & "0" & "0" & "0" & sink_channel(18 DOWNTO 5));
 ...
 END RTL; --fluid_board_soc_mm_interconnect_0_rsp_demux_001
