...
--synthesis_resources = 
 ...
 ENTITY  fluid_board_soc_mm_interconnect_1_cmd_demux IS 
	 ...
	 ( 
		 ...
		 src1_data	:	OUT  STD_LOGIC_VECTOR (160 DOWNTO 0);
		 ...
		 src2_data	:	OUT  STD_LOGIC_VECTOR (160 DOWNTO 0);
		 src2_endofpacket	:	OUT  STD_LOGIC;
		 src2_ready	:	IN  STD_LOGIC;
		 src2_startofpacket	:	OUT  STD_LOGIC;
		 src2_valid	:	OUT  STD_LOGIC
	 ); 
 END fluid_board_soc_mm_interconnect_1_cmd_demux;

 ARCHITECTURE RTL OF fluid_board_soc_mm_interconnect_1_cmd_demux IS
 ...
 END RTL; --fluid_board_soc_mm_interconnect_1_cmd_demux
