...
--synthesis_resources = 
 ...
 ENTITY  fluid_board_soc_mm_interconnect_0_cmd_demux_002 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
		 ...
		 sink_valid	:	IN  STD_LOGIC_VECTOR (18 DOWNTO 0);
 ...
 END fluid_board_soc_mm_interconnect_0_cmd_demux_002;

 ARCHITECTURE RTL OF fluid_board_soc_mm_interconnect_0_cmd_demux_002 IS
 ...
 END RTL; --fluid_board_soc_mm_interconnect_0_cmd_demux_002
