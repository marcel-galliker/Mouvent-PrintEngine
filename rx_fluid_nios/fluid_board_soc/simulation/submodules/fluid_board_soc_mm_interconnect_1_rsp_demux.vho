...
--synthesis_resources = 
 ...
 ENTITY  fluid_board_soc_mm_interconnect_1_rsp_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END fluid_board_soc_mm_interconnect_1_rsp_demux;

 ARCHITECTURE RTL OF fluid_board_soc_mm_interconnect_1_rsp_demux IS
 ...
 END RTL; --fluid_board_soc_mm_interconnect_1_rsp_demux
