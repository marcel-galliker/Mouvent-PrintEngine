// fluid_board_soc_sld_hub_controller_system_0.v
...
`timescale 1 ps / 1 ps
module fluid_board_soc_sld_hub_controller_system_0 #(
	...
	fluid_board_soc_sld_hub_controller_system_0_link link (
	...
	fluid_board_soc_sld_hub_controller_system_0_fabric fabric (
		.clk_clk             (clk_clk),                             //     clk.clk
	...
	fluid_board_soc_sld_hub_controller_system_0_hub_controller #(
	...
	fluid_board_soc_sld_hub_controller_system_0_avalon_st_adapter #(
		.inBitsPerSymbol (1),
		.inUsePackets    (0),
		.inDataWidth     (1),
		.inChannelWidth  (8),
