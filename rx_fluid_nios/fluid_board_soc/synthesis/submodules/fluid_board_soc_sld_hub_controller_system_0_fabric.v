// fluid_board_soc_sld_hub_controller_system_0_fabric.v
...
`timescale 1 ps / 1 ps
module fluid_board_soc_sld_hub_controller_system_0_fabric (
	...
	fluid_board_soc_sld_hub_controller_system_0_fabric_demux demux (
		.clk                (clk_clk),                  //   clk.clk
	...
	fluid_board_soc_sld_hub_controller_system_0_fabric_mux mux (
		.clk               (clk_clk),                  //   clk.clk
		.reset_n           (~reset_reset),             // reset.reset_n
	...
	fluid_board_soc_sld_hub_controller_system_0_fabric_mgmt_demux mgmt_demux (
		.clk        (clk_clk),                    //   clk.clk
		.reset_n    (~reset_reset),               // reset.reset_n
	...
	fluid_board_soc_sld_hub_controller_system_0_fabric_mgmt_time_adap mgmt_time_adap (
		.clk         (clk_clk),                    //   clk.clk
		.reset_n     (~reset_reset),               // reset.reset_n
