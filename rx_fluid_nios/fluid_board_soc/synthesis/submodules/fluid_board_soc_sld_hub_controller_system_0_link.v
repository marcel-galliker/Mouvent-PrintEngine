// fluid_board_soc_sld_hub_controller_system_0_link.v
...
`timescale 1 ps / 1 ps
module fluid_board_soc_sld_hub_controller_system_0_link (
	...
	fluid_board_soc_sld_hub_controller_system_0_link_write_slave_to_source write_slave_to_source (
	...
	fluid_board_soc_sld_hub_controller_system_0_link_h2t_timing_adapter h2t_timing_adapter (
		.clk       (clk_clk),                         //   clk.clk
	...
	fluid_board_soc_sld_hub_controller_system_0_link_h2t_channel_adapter h2t_channel_adapter (
		.clk               (clk_clk),                                            //   clk.clk
		.reset_n           (~reset_reset),                                       // reset.reset_n
	...
	fluid_board_soc_sld_hub_controller_system_0_link_t2h_channel_adapter t2h_channel_adapter (
		.clk               (clk_clk),                               //   clk.clk
		.reset_n           (~reset_reset),                          // reset.reset_n
	...
	fluid_board_soc_sld_hub_controller_system_0_link_t2h_timing_adapter t2h_timing_adapter (
		.clk       (clk_clk),                       //   clk.clk
		.reset_n   (~reset_reset),                  // reset.reset_n
	...
	fluid_board_soc_sld_hub_controller_system_0_link_sink_to_read_slave sink_to_read_slave (
		.wrclock                         (clk_clk),                                               //   clk_in.clk
		.reset_n                         (~reset_reset),                                          // reset_in.reset_n
	...
	fluid_board_soc_sld_hub_controller_system_0_link_mm_interconnect_0 mm_interconnect_0 (
	...
	fluid_board_soc_sld_hub_controller_system_0_link_mm_interconnect_1 mm_interconnect_1 (
		.clock_bridge_out_clk_clk                                 (clk_clk),                                                 //                               clock_bridge_out_clk.clk
	...
	fluid_board_soc_sld_hub_controller_system_0_link_mm_interconnect_2 mm_interconnect_2 (
		.clock_bridge_out_clk_clk                                (clk_clk),                                                //                              clock_bridge_out_clk.clk
