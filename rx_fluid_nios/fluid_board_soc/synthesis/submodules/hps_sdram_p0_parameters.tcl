...
set ::GLOBAL_hps_sdram_p0_uniphy_temp_ver_code 1685627634
# PLL Parameters
...
set ::GLOBAL_hps_sdram_p0_pll_mult(0) 80
set ::GLOBAL_hps_sdram_p0_pll_div(0) 6
set ::GLOBAL_hps_sdram_p0_pll_phase(0) 0.0
set ::GLOBAL_hps_sdram_p0_pll_mult(PLL_AFI_CLK) 80
set ::GLOBAL_hps_sdram_p0_pll_div(PLL_AFI_CLK) 6
set ::GLOBAL_hps_sdram_p0_pll_phase(PLL_AFI_CLK) 0.0
set ::GLOBAL_hps_sdram_p0_pll_mult(1) 80
set ::GLOBAL_hps_sdram_p0_pll_div(1) 6
set ::GLOBAL_hps_sdram_p0_pll_phase(1) 0.0
set ::GLOBAL_hps_sdram_p0_pll_mult(PLL_MEM_CLK) 80
set ::GLOBAL_hps_sdram_p0_pll_div(PLL_MEM_CLK) 6
set ::GLOBAL_hps_sdram_p0_pll_phase(PLL_MEM_CLK) 0.0
set ::GLOBAL_hps_sdram_p0_pll_mult(2) 80
set ::GLOBAL_hps_sdram_p0_pll_div(2) 6
set ::GLOBAL_hps_sdram_p0_pll_phase(2) 270.0
set ::GLOBAL_hps_sdram_p0_pll_mult(PLL_WRITE_CLK) 80
set ::GLOBAL_hps_sdram_p0_pll_div(PLL_WRITE_CLK) 6
set ::GLOBAL_hps_sdram_p0_pll_phase(PLL_WRITE_CLK) 270.0
set ::GLOBAL_hps_sdram_p0_pll_mult(3) 80
set ::GLOBAL_hps_sdram_p0_pll_div(3) 6
set ::GLOBAL_hps_sdram_p0_pll_phase(3) 270.0
set ::GLOBAL_hps_sdram_p0_pll_mult(PLL_ADDR_CMD_CLK) 80
set ::GLOBAL_hps_sdram_p0_pll_div(PLL_ADDR_CMD_CLK) 6
