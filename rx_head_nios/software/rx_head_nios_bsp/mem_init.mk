...
# Memory: dp_ram_nios_arm
MEM_0 := soc_system_dp_ram_nios_arm
$(MEM_0)_NAME := dp_ram_nios_arm
...
$(MEM_0)_HIERARCHICAL_PATH := dp_ram_nios_arm
$(MEM_0)_WIDTH := 16
$(MEM_0)_HEX_DATA_WIDTH := 16
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: dp_ram_nios_arm
dp_ram_nios_arm: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: onchip_memory_nios_cpu
MEM_1 := soc_system_onchip_memory_nios_cpu
