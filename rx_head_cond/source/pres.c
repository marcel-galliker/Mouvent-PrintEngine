...
{    		
	...
	if (RX_Status.mode == ctrl_print || (RX_Status.mode >= ctrl_recovery_start && RX_Status.mode <= ctrl_recovery_step2)) RX_Status.info.flowFactor_ok = (RX_Status.flowFactor < 200);
